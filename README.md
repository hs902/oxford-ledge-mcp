...
> **Version:** 3.4.0 (gov-public-data-only surface; CUSIP + third-party-FRED carve-outs)
...
| Tool | Mode | Description |
|------|:-:|-------------|
| `search_bdc_borrower` | A | Which BDCs lend to a borrower — one row per tranche, stale holders labelled, current-holder aggregates (SEC SoI; Oxford Ledge parse, ol-derived) |
